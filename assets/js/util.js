(function ($) {
  ...
  //Botao Ler mais
  $.fn.adicionarEventoLerMais = function () {
	return this.each(function () {
	  var botao = $(this);
	  var conteudoLongo = botao.prev('.conteudo-longo');
	  var textoLerMais = "Ler mais";
	  var textoLerMenos = "Ler menos";
  
	  botao.on("click", function () {
		conteudoLongo.toggleClass("escondido");
  
		if (conteudoLongo.hasClass("escondido")) {
		  botao.text(textoLerMais);
		} else {
		  botao.text(textoLerMenos);
		}
	  });
	});
  };
